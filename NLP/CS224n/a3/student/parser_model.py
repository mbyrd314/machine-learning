...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden_weight = nn.Parameter(torch.ones((self.embed_size*self.n_features, hidden_size)))
    ...
    def forward(self, w):
        ...
        x = x.mm(self.embed_to_hidden_weight) + self.embed_to_hidden_bias
        h = F.relu(x)
